...
SHARED_SRCS			:= 	$(SRC_DIR)init_vars.c \
						$(SRC_DIR)dinner.c \
						$(SRC_DIR)ft_philo.c \
						$(SRC_DIR)main.c \
						$(SRC_DIR)monitor.c \
						$(SRC_DIR)write_status.c \
						$(SRC_DIR)assign_forks.c \
						...
						$(SRC_DIR)store_args.c \
						$(SRC_DIR)validate_args.c \
						$(SRC_DIR)get_time.c \
						$(SRC_DIR)check_end_simulation.c \
						$(SRC_DIR)get_state_mutex.c \
						$(SRC_DIR)set_state_mutex.c \
